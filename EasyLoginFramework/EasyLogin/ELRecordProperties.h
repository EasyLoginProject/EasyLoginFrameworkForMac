...
-(void)updateWithProperties:(nonnull ELRecordProperties*)updatedProperties deletes:(BOOL)deleteWhenAbsent kvoNotifier:(nullable id)kvoNotifier; // kvoNotifier allows the KVO poster to be custom, such as the ELRecord owner for example
